                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    ...
                                    @if ($experiencia['descripcion'] != '')
                                        <a data-toggle="collapse" href="#collapse{{ $experiencia['codigo'] }}" role="button" aria-expanded="false" aria-controls="collapse"><i class="fas fa-plus-circle rva-color rva-icono" data-fa-i2svg=""></i></a></li>
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    ...
                                    @if ($formacion['descripcion'] != '')
                                        <a data-toggle="collapse" href="#collapse{{ $formacion['codigo'] }}" role="button" aria-expanded="false" aria-controls="collapse"><i class="fas fa-plus-circle rva-color rva-icono" data-fa-i2svg=""></i></a></li>
